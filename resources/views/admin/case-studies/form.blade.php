...
<div class="admin-form-grid">
  ...
  <div class="admin-field">
    ...
    <input id="published_at" class="admin-input" type="datetime-local" name="published_at" value="{{ old('published_at', optional($caseStudy->published_at)->format('Y-m-d\\TH:i')) }}">
  ...
  <div class="admin-field admin-field-wide">
    ...
    <input id="canonical_url" class="admin-input" type="url" name="canonical_url" value="{{ old('canonical_url', $caseStudy->canonical_url) }}" placeholder="https://anbias.com/case-studies/your-slug">
  </div>
</div>
...
<script>
  ClassicEditor.create(document.querySelector('#contentEditor')).catch((error) => {
    console.error(error);
  });
</script>
